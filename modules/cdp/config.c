/**
 * $Id: config.c 1078 2011-04-20 09:33:35Z vingarzan $
 *
 ...
 */
inline dp_config *new_dp_config(void)
{
	dp_config *x;
	...
	return x;
error:
	LM_ERR("ERROR:%s(): failed to create new dp_config.\n",__FUNCTION__);
	return 0;
}
 ...
 * Create a new dp_config.
 */
inline routing_realm *new_routing_realm(void)
{
	routing_realm *x;
	...
	return x;
error:
	LM_ERR("ERROR:%s(): failed to create new routing_realm.\n",__FUNCTION__);
	return 0;
}
 ...
 * Create a new dp_config.
 */
inline routing_entry *new_routing_entry(void)
{
	routing_entry *x;
	...
	return x;
error:
	LM_ERR("ERROR:%s(): failed to create new routing_entry.\n",__FUNCTION__);
	return 0;
}
