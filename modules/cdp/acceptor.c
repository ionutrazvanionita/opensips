/**
 * $Id: acceptor.c 257 2007-04-26 12:44:54Z vingarzan $
 *
...
/* wrapper to comply with new OpenSIPS design */
void acceptor_process_w(int id)
{

	LM_INFO("acceptor process started %d\n", id);
	dp_add_pid(getpid());
